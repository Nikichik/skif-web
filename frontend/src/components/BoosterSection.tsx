      ...
      <div className="grid grid-cols-1 xl:grid-cols-[260px_1fr] gap-4 items-stretch">
        ...
        {chartData.length > 0 && (
          <div className="bg-panel-card border border-panel-border rounded-lg p-4">
            <h4 className="text-base text-gray-200 mb-2">Энергия и ток за цикл бустера</h4>
            <ResponsiveContainer width="100%" height={430}>
              <LineChart data={chartData} margin={{ top: 10, right: 40, left: 20, bottom: 36 }}>
                ...
                />
                <Legend wrapperStyle={{ fontSize: 12, bottom: -6 }} />
                <ReferenceLine
                  yAxisId="energy"
                  x={injTimeMs}
                  stroke="#22C55E"
